...
\subtitle{A tutorial}
\author{\myauthor}
\publishers{University of Koblenz-Landau}
\date{Last changed: September 3, 2015}
\begin{document}
\maketitle
\tableofcontents
...
Being originated as part of my dissertation, the work presented here was partially supported by the DFG (grant RU-1524/2-1).
\begin{FlushRight}
  Michael Helmling\\
  \href{mailto:michaelhelmling@posteo.de}{michaelhelmling@posteo.de}\\
